...
namespace TM_2
{
	...
	public partial class LoadHourDialog : Form
	{
		...
		void OKButtonClick(object sender, EventArgs e)
		{
			...
			while((dataGridView1.Rows.Count > i) && !dataGridView1.Rows[i].Cells[DateBeginCell.X].Value.ToString().Equals(""))
			{
				resultTable.Rows.Add(dataGridView1.Rows[i].Cells[DateBeginCell.X].Value, 
				                     dataGridView1.Rows[i].Cells[HourBeginCell.X].Value);
				i++;
			}
			try
			{
